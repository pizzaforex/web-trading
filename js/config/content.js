        ...
        sections: [
            ...
            },
            {
            ...
            },
             {
                ...
                `,
                 challenges: [] // No challenges specific to this section definition
            },
            {
                id: 'framework',
                ...
                `,
                 challenges: [
                    { id: '20-trade-series', title: 'Sfida Chiave: Serie di 20 Trade', description: 'Applica l\'esercizio "Operare come un Casinò" per i tuoi prossimi 20 trade (reali o simulati). Concentrati SOLO sull\'esecuzione perfetta delle tue regole predefinite. Tieni un diario dettagliato.', reward: 50, linkText: 'Inizia la Serie Simulata' }
                ]
            },
             {
                id: 'risorse',
                ...
                `,
                 challenges: [] // La challenge del diario è ora parte del content, non un oggetto challenge separato qui.
            }
        ]
    },
    'placeholder-1': {
        ...
        sections: [
             {
                id: 'intro-ta',
                title: 'Introduzione all\'Analisi Tecnica (Placeholder)',
                icon: 'fa-chart-line',
                content: `<p>Questa sezione spiegherà i fondamenti dell'analisi tecnica.</p>
                         <div class="card"><p>Contenuto sull'analisi dei grafici, trend, supporti, resistenze e indicatori principali verrà inserito qui.</p></div>`,
                challenges: []
             }
        ]
    },
         ...
         sections: [
             {
                ...
                content: `<p>Questa sezione introdurrà i concetti cruciali della gestione del rischio nel trading.</p>
                          <div class="card"><p>Contenuto su stop loss, position sizing, rapporto rischio/rendimento, capitale a rischio e diversificazione verrà inserito qui.</p></div>`,
                 challenges: []
             }
         ]
    }
